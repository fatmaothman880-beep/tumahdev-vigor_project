...
export const readingsByVessel: Record<number, OperationalReading[]> = {
  201: [
...
export const delaysByVessel: Record<number, DelayEvent[]> = {
  201: [
    {
      id: nextId(),
      start: mk(7, 22),
...
export const eventsByVessel: Record<number, OperationalEvent[]> = {
  201: [
