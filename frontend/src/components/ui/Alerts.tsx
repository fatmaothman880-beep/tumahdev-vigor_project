...
export function AlertsFeed({ alerts, onSelectVessel }: { alerts: OperationalAlert[]; onSelectVessel: (id: string | number) => void }) {
  if (alerts.length === 0) {
    return (
...
export function NotificationBell({ alerts, onSelectVessel }: { alerts: OperationalAlert[]; onSelectVessel: (id: string | number) => void }) {
